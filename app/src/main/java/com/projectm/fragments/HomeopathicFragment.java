...
public class HomeopathicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<MedicineCards> options =
                new FirebaseRecyclerOptions.Builder<MedicineCards>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Disease").child(diseaseType).child(diseaseName).child("Medicine").child("Homeopathic"), MedicineCards.class)
                        .build();
